...
public class AuthService {
    ...
    public AuthService(ObjectMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public Map<String, Object> login(LoginRequest authRequest) throws Exception {
        ...
        if (foundUser.isPresent()) {
            ...
            if (!passwordEncoder.matches(authRequest.getPassword(), user.getPasswordHash())) {
                logger.warn("Invalid password for user: {}", authRequest.getUsername());
            ...
            logger.warn("Invalid username: {}", authRequest.getUsername());
            return Map.of("message", INVALID_USERNAME_OR_PASSWORD);
        }
    }
